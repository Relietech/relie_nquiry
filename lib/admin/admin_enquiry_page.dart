...
class AdminEnquiryPage extends StatefulWidget {
  const AdminEnquiryPage({super.key});

  @override
  State<AdminEnquiryPage> createState() => _AdminEnquiryPageState();
}

class _AdminEnquiryPageState extends State<AdminEnquiryPage> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('Enquiry', style: AppTextStyles.appBarWhite21bold),
